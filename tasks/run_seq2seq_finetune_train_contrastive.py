...
from module.finetune_model import (
    FinetuneSeq2SeqModel,
    FinetuneWithContrastEfficientSeq2SeqModel,
)
...
def _load_data(args):
    ...
    train_set = CNNDailyWithCandidatesSeq2SeqDataset(
        data_dir="/mnt/d/MLData/data/summarization/cnndm_bart/cnndm/diverse/train/",
    ...
    val_set = CNNDailyWithCandidatesSeq2SeqDataset(
...
def main(args):
    ...
    trainer = pl.Trainer(
        ...
        deterministic=False,  # RuntimeError: scatter_add_cuda_kernel does not have a deterministic implementation, but you set 'torch.use_deterministic_algorithms(True)'.
    )
